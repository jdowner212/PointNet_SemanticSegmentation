...
def eval_one_epoch(sess, ops, room_path, out_data_label_filename, out_gt_label_filename):
    ...
    current_data, current_label = indoor3d_util_TEST.room2blocks_wrapper_normalized(room_path, NUM_POINT)
    ...
    for batch_idx in range(num_batches):
        ...
        for b in range(BATCH_SIZE):
            ...
            for i in range(NUM_POINT):
                color = indoor3d_util_TEST.g_label2color[pred[i]]
                color_gt = indoor3d_util_TEST.g_label2color[current_label[start_idx+b, i]]
                if FLAGS.visu:
